 ...
 * @Package: com.zzyu.zzyushiroredis.shiro
 * @ClassName: ShiroConfigTwo
 * @Author: zeyu.zhang
 * @Description: ${description}
 * @Date: 2019/11/4 12:53
 * @Version: 1.0
 */
public class ShiroConfigTwo {
    ...
    private Filter kickoutSessionControlFilter() {
        Filter filter = new LoginAcountCountFilter();
        return  filter;
    }
...
//    @Bean("sessionManager")
    public SessionManager sessionManager() {
        ...
        //配置监听
//        listeners.add(sessionListener()); //暂时不使用
